...
sub get_header {
    ...
    my $lab_navigation = "<div id=\"navigation_lab\">" .
			 ...
			 "&nbsp;&nbsp;<a href=\"https://twitter.com/salilab_ucsf\" class=\"fab fa-twitter\" title=\"Follow us on Twitter\"></a>" .
                         "</div>" .
                        "<p class=\"standout\">The compute cluster will be down for maintenance from Feb 22nd until Feb 23rd. Most jobs will be queued until the cluster is back up.</p>";
